# Terms of Service — Synabit

**Last updated:** May 10, 2026  
**Effective date:** May 10, 2026

These Terms of Service ("Terms") govern your use of the Synabit application ("the App") and any related services provided by Synabit ("we", "us", "our"). By using the App, you agree to these Terms.
...
### 3.1 Free Use (Source-Available)

The source code of Synabit is publicly available under the Synabit Source Available License. You may compile and use the App for **personal, non-commercial purposes** at no cost.

### 3.2 Paid Subscription

To use the App for commercial purposes or to access the officially distributed version with support, you must purchase a subscription:

| Plan | Price | Billing |
|---|---|---|
| Monthly | $5 USD / month | Charged monthly |
| Annual | $50 USD / year | Charged annually (save ~17%) |
...
We may offer a free trial period at our discretion. At the end of the trial, your subscription will begin unless you cancel before the trial expires.
...
- Refund requests after 14 days are evaluated on a case-by-case basis.
- To request a refund, contact support@synabit.app.
...
- Not use the App to store or transmit illegal, harmful, or infringing content.
- Maintain the security of your device and account credentials.
- Not attempt to reverse engineer the distributed binary for purposes of circumventing the subscription requirement.

## 5. Intellectual Property

### 5.1 Our Rights

The App, including its source code, design, documentation, trademarks, and branding, is owned by Synabit and protected by copyright and intellectual property laws. The source code is made available under the Synabit Source Available License (see LICENSE file).
...
We do not guarantee that the App will be error-free, uninterrupted, or free of harmful components. The App runs locally on your device and is subject to your device's capabilities and limitations.
...
- **Email**: legal@synabit.app
- **GitHub**: https://github.com/synabit/synabit/issues

---

*By using Synabit, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.*
