  ...
  <div class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-base dark:bg-base-dark">
      <div class="max-w-xl w-full flex flex-col gap-8 animate-in fade-in slide-in-from-bottom-8 duration-500">
          ...
          <div class="text-center">
              ...
              <h1 class="text-3xl font-bold text-text dark:text-text-dark mb-2">Welcome to Synabit Finance</h1>
              <p class="text-gray-500 dark:text-gray-400">Set up your accounts and initial balances to start your financial management journey.</p>
          </div>
          
          <div class="bg-surface dark:bg-surface-dark border border-border dark:border-border-dark rounded-3xl p-6 shadow-xl">
              <h2 class="text-lg font-bold text-text dark:text-text-dark mb-4">Declare Current Assets</h2>
              ...
              <div class="flex flex-col gap-2 p-3 bg-blue-50/50 dark:bg-blue-900/10 rounded-xl border border-blue-100 dark:border-blue-900/30 border-dashed mb-6">
                  <input type="text" v-model="newAccountName" class="w-full bg-white dark:bg-gray-800 border border-border dark:border-border-dark rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Add another account (e.g. PayPal)" />
                  <div class="flex gap-2">
                      <div class="relative flex-1">
                          <input type="text" inputmode="numeric" :value="newAccountBalance" @input="handleBalanceInput" class="w-full bg-white dark:bg-gray-800 border border-border dark:border-border-dark rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 pr-4" placeholder="Current balance" />
                      </div>
