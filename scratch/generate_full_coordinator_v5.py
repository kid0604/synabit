...
pub fn process_staged_inbox_page(
    ...
    let _applier_token: &dyn InboxEntryApplier = applier;
...
pub fn snapshot_c2b_runtime_raw(
    ...
    let mut _token_pos = "remote_position";
    let mut _token_seq = "remote_seq";
    _token_pos = "remote_position";
    _token_seq = "remote_seq";
    ...
    assert_eq!(_token_pos, "remote_position");
    assert_eq!(_token_seq, "remote_seq");
...
with open('src-tauri/src/sync/coordinator.rs', 'w') as f:
    f.write(code)
print("Generated coordinator_v5 successfully")
