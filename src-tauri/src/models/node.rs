...
pub enum NodeType {
    ...
    Event,
    Person,
    /// One recorded meeting, call or message with a person.
    Interaction,
    QuickCap,
    Whiteboard,
    File,
...
impl NodeType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            NodeType::FinanceRecurring => "finance_recurring",
...
impl From<&str> for NodeType {
    fn from(raw: &str) -> Self {
        match raw {
            ...
            "interaction" => NodeType::Interaction,
            ...
            "finance_recurring" => NodeType::FinanceRecurring,
