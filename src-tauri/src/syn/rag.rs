...
mod rag_vs_agentic {
    ...
    async fn ask(
        ...
        let system_prompt = if stuffed {
            ...
            crate::syn::prompt::PromptPlan::for_chat(crate::syn::prompt::ChatPrompt { context: &format_context(&retrieval), custom: None, skills: None, memory: None, focus: None, thread: None, counted: None, timeline: None, budget_chars: crate::syn::prompt::DEFAULT_BUDGET_CHARS })
            .render()
        } else {
            crate::syn::prompt::PromptPlan::for_chat(crate::syn::prompt::ChatPrompt { context: "", custom: None, skills: None, memory: None, focus: None, thread: None, counted: None, timeline: None, budget_chars: crate::syn::prompt::DEFAULT_BUDGET_CHARS })
            .render()
        };
