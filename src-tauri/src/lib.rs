...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler({
            ...
            commands::timeline::timeline_read_line,
            commands::timeline::timeline_write_event,
            commands::timeline::timeline_moment,
            commands::timeline::timeline_moment_write,
            commands::timeline::timeline_moment_delete,
            commands::timeline::timeline_reset_plan,
            commands::timeline::timeline_reset,
            commands::timeline::timeline_presence,
            commands::timeline::timeline_frame,
            commands::timeline::timeline_about,
            commands::timeline::timeline_not_again,
            commands::timeline::timeline_drop_line,
            commands::timeline::timeline_ask,
            commands::timeline::timeline_pin,
            commands::timeline::timeline_unpin,
            commands::timeline::timeline_pins,
            commands::timeline::timeline_set_aside,
