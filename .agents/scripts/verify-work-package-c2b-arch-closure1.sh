...
# External lifecycle-independent acceptance oracle for C2B-ARCH-CLOSURE-1-V1.
# It intentionally does not read checkpoint state or Builder evidence.
...
harness_arch="$repo_root/.agents/oracles/c2b_arch_closure_v1.rs"
...
printf 'Synabit C2B architecture closure — C2B-ARCH-CLOSURE-1-V1 / C2B-ORACLE-V4\n'
...
check_digest 'immutable architecture closure harness' "$harness_arch" '8f3bb112f50b822e0154ae189454cc0433a49d6c444c7760e0a9b307dda2d811'
...
run_cargo_gate 'accepted C2B inbox/outbox malformed snapshot behavior' 'frc2b_r1_04'
run_cargo_gate 'C2B architecture closure behavior' 'c2b_arch_'
...
if (( failure_count > 0 )); then
  printf 'C2B_ORACLE_V4_FAIL failures=%s\n' "$failure_count"
  exit 1
fi

printf 'C2B_ORACLE_V4_PASS\n'
