...
# Lifecycle-independent acceptance oracle for C2B-ARCH-CLOSURE-3-V1.
...
printf 'Synabit C2B architecture closure 3 — C2B-ARCH-CLOSURE-3-V1 / C2B-ORACLE-V6\n'

# Immutable resource and accepted-scope digests are filled by the external
# publisher before this oracle is frozen.
...
check_digest 'scope lock: accepted legacy migration and corrupt fixture' "$app_root/src/db/legacy_sync_migration.rs" '8a5e7f13df1ab37f1b87502b0219403ac833674ba5e21bd3ea3d5bef999395cd'
...
run_cargo_gate 'C2B V6 exact-invariant behavior' 'c2b_arch_closure_v3::c2b_arch_v6_'
...
if (( failure_count > 0 )); then
  printf 'C2B_ORACLE_V6_FAIL failures=%s\n' "$failure_count"
  exit 1
fi

printf 'C2B_ORACLE_V6_PASS\n'
