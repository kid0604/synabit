...
# Lifecycle-independent acceptance oracle for D1-TOMBSTONE-IDENTITY-V1.
...
d1_structural="$repo_root/.agents/oracles/d1_tombstone_identity_structural.py"
...
printf 'Synabit D1 typed tombstone identity — D1-TOMBSTONE-IDENTITY-V1 / D1-ORACLE-V1\n'

check_digest 'immutable D1 behavioral harness' "$d1_harness" '99148452aa93e0ef0e208468c9d6a0829d1b15f9a8df48f4250eb91998f8d0c6'
check_digest 'immutable D1 structural analyzer' "$d1_structural" 'c16bb61849d712a3600e92af950099e3af286d18cce2eadc1f14b68b18e42884'
...
if (( failure_count > 0 )); then
  printf 'D1_ORACLE_V1_FAIL failures=%s\n' "$failure_count"
  exit 1
fi

printf 'D1_ORACLE_V1_PASS\n'
